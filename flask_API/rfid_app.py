...
class RFIDApplication:
    ...
    def _initialize_serial(self):
        try:
            ...
            return Serial('/dev/ttyUSB0', 115200, timeout=0.01)
    ...
    def send_rfid_cmd(self, cmd):
        try:
            ...
            if self.rfid_serial and self.rfid_serial.is_open:
                ...
                response = self.rfid_serial.read(30)
                if response:
        ...
        try:
            while True:
                try:
                    ...
                    if tag_data:
                        if 'E2 00 20 23 12 05 EE AA 00 01 00 86' in tag_data or 'E2 00 20 23 12 05 EE AA 00 01 00 89' in tag_data:
                            duty_cycle = 0.5
