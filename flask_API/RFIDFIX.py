                ...
                try:
                    ...
                    if tag_data:
                        if 'E2 00 20 23 12 05 EE AA 00 01 00 87' in tag_data: 
                            ...
                            name = 'Tag 1'
                        elif 'E2 00 20 23 12 05 EE AA 00 01 00 88' in tag_data:
                            duty_cycle = 0.4
                            tag_id = 'E2 00 20 23 12 05 EE AA 00 01 00 88'
                            name = 'Tag 2'
                        elif 'E2 00 20 23 12 05 EE AA 00 01 00 85' in tag_data:
                            duty_cycle = 0.3
                            tag_id = 'E2 00 20 23 12 05 EE AA 00 01 00 85'
                            name = 'Tag 3'
                        elif 'E2 00 20 23 12 05 EE AA 00 01 00 89' in tag_data:
                            duty_cycle = 0.2
                            tag_id = 'E2 00 20 23 12 05 EE AA 00 01 00 89'
                            name = 'Tag 4'
                        elif 'E2 00 20 23 12 05 EE AA 00 01 00 86' in tag_data:
                            duty_cycle = 0
